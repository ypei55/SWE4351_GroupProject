...
public class SipCalc extends SaveCalcs {
    ...
    public void calculateSIP(){
        ...
        logCalculations("Your inputs were Rs "+ principleAmt + " for " + InvestDuration + " years with a rate of return of " + (returnRate * 100) + " % and the result of the " + getName + " operation was Rs. " + future_value);
    }
}
