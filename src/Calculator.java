...
import Inputs.MultiInput;

import Inputs.SingleInput;

import Operations.Nthroot;

import Operations.SciCalcs;

import Operations.SipCalc;

import Operations.Storage;

import Operations.b2d;

import Operations.basicCalcs;

import Operations.d2b;
        ...
        try {
            if (operation == 1) {
                ...
                System.out.println("The answer is : " +
                        basicCalcs.Add(var[0], var[1]));
            } else if (operation == 2) {
                int[] var = MultiInput.UserInput();
                System.out.println("The answer is : " +
                        basicCalcs.Subtract(var[0], var[1]));
            } else if (operation == 3) {
                int[] var = MultiInput.UserInput();
                System.out.println("The answer is : " +
                        basicCalcs.Multiply(var[0], var[1]));
            } else if (operation == 4) {
                int[] var = MultiInput.UserInput();
                System.out.println("The answer is : " +
                        basicCalcs.Divide(var[0], var[1]));
            } else if (operation == 5) {
                int[] var = MultiInput.UserInput();
                System.out.println("The answer is : " +
                        basicCalcs.PowerOf(var[0], var[1]));
            } else if (operation == 6) {
            ...
            System.out.println("Invalid input!" +
                    "Please enter a choice from 1 to 20");
        }

        System.out.println("Please enter N to perform another calculation"
